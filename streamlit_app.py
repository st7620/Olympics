...
with col[2]:
    ...
    with st.expander('About', expanded=True):
        st.write('''
            ...
            - The second graph shows the predicted total number of medals for each country. The predictions are based on a K-Nearest Neighbors Regression model that was trained on the historical data. I hypothesized that the countries that have won the most medals in the past will continue to win the most medals in the future (especially the US), which is supported by my predictions.
